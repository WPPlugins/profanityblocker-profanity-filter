...
/*  Copyright 2013  AstrizStudios  (email : support@profanity-blocker.com)
...
require_once('profanity-blocker_hclass.php');

define('ASTRIZSTUDIOS_PROBLOCK_LINK_API', 'http://data.profanity-blocker.com/api.php');
define('ASTRIZSTUDIOS_PROBLOCK_LINK_SERVICE', 'http://service.profanity-blocker.com/restServer.php');

//Make it active as soon as it is activated
register_activation_hook( __FILE__, 
							function() //No calls to other functions, or it will not work, we need to do it right then..
							{
...
//later on
//Make people able to deactivate it as soon as they want to
//register_deactivation_hook(__FILE__, 'astrizstudios_pro_block_options_deactivate');

//function astrizstudios_pro_block_options_deactivate()
//{
//		remove
//}
...
require_once('profanity-blocker_wpcore.php');

/* -------------------------------------------------------- BuddyPress section ------------------------------------------------------- */

require_once('profanity-blocker_bpcore.php');

/* --------------------------------------------------------- bbPress section --------------------------------------------------------- */

require_once('profanity-blocker_bbcore.php');

/* -------------------------------------------------------- Administration section -------------------------------------------------------- */

require_once('profanity-blocker_admin.php');
